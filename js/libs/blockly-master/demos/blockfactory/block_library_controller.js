 ...
 * updateWorld the view and the selected block accordingly.
...
BlockLibraryController.prototype.addOptionSelectHandler = function(blockType) {
  ...
  var setSelectedAndOpen_ = function(blockOption) {
    ...
    // Thus, the buttons show up as a disabled updateWorld button and an enabled
    // delete.
...
/**
 * Add select handlers to each option to updateWorld the view and the selected
 * blocks accordingly.
 */
