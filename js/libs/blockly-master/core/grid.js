...
/**
 * Set the attributes on one of the lines in the grid.  Use this to updateWorld the
 * length and stroke width of the grid lines.
 * @param {!SVGElement} line Which line to updateWorld.
...
Blockly.Grid.createDom = function(rnd, gridOptions, defs) {
  ...
  */
  ...
  if (gridOptions['length'] > 0 && gridOptions['spacing'] > 0) {
    ...
    // x1, y1, x1, x2 properties will be set later in updateWorld.
  } else {
